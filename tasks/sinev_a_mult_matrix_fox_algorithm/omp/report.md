...
Умножение плотных матриц является одной из ключевых задач высокопроизводительных вычислений.
Данная операция активно используется в линейной алгебре, машинном обучении, моделировании физических
процессов и научных вычислениях.

В данной работе реализован параллельный алгоритм умножения квадратных матриц с использованием OpenMP.
В основе реализации лежит блочная схема алгоритма Фокса, позволяющая эффективно распределять вычисления
между потоками и улучшать локальность данных.

Цель работы — реализовать многопоточную версию алгоритма умножения матриц, проверить корректность
вычислений и оценить производительность OpenMP реализации.
